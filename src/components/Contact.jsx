...
const Contact = ({ darkMode }) => {
  return (
    ...
    id="contact"
    style={{
        backgroundColor: darkMode ? '#111827'
 : '#f9fafb'    }}
 className="py-12 sm:py-16 md:py-20 lg:py-24 overflow-hidden">
     <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:md-10 md:mb-12"
        data-aos="fade-up">
            <h2
       ...
       sm:gap-8 md:gap-10 items-center">
        ...
        data-aos="fade-right">
            ...
            className='full max-w-xs sm:max-w-sm lg:max-w-md
            h-auto objet-contain' />

        </div>
        <form
        style={{
            background: darkMode ?'liner-gradient( to right, #1f29347, #111827)'
